...
import { MdOutlineClose, MdWest } from "react-icons/md";
            ...
            <div>
                {productData.map((item) => (
                    ...
                    >
                        ...
                        <div
                            className='flex flex-col items-center justify-between text-gray-500 gap-2 
                                 md:w-52 md:flex md:items-center md:justify-between md:text-gray-500 md:gap-4 md:border md:p-3'>
